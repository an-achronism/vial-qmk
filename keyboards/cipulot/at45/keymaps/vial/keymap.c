...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        KC_LSHIFT, KC_NUBS, KC_Z,    KC_X, KC_C,   KC_V, KC_B,   KC_N,   KC_M, KC_COMMA, KC_DOT,  KC_SLSH, KC_RSHIFT, MO(1),
        KC_LCTRL,  KC_LGUI, KC_LALT,       KC_SPC,       KC_SPC, KC_SPC,                 KC_RALT, KC_RGUI, MO(1),     KC_RCTRL),
